  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: "Герой не может поделиться болью: его горе слишком велико, а окружающие либо не понимают, либо сами пережили подобное. Он чувствует себя «выжженным» изнутри.",
      },
      {
        heading: "Дать надежду",
        text: "История усыновления Ванюшки даёт надежду на то, что даже в самых тяжёлых обстоятельствах человек может найти в себе силы продолжать жить и заботиться о других.",
      },
    ],
    isCover: false,
  },
    ...
    content: [
      {
        ...
        text: "Даже в самых тяжёлых обстоятельствах человек может найти в себе силы продолжать жить и заботиться о других.",
      },
      {
        heading: "Призыв к действию",
        text: "Вспомнить, как война лишает человека самых важных вещей, и понять, как это может влиять на душу.",
      },
      {
        heading: "Путь к преодолению",
        text: "Найти в себе силы преодолеть одиночество — например, через заботу о другом человеке, как это делает Андрей Соколов.",
      },
    ],
    isCover: false,
  },
